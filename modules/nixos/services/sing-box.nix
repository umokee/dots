...
let
  enable = lib.elem "singbox" (vars.services.enable or [ ]);
  ...
  singboxSettings = {
    dns = {
      ...
      rules = [
        ...
        {
          process_path = [
            "/home/user/.nix-profile/bin/mullvad-browser"
          ];
          server = "dns-remote";
        }
        {
    ...
    outbounds = [
      {
        ...
        server_port = 443;
        uuid = "79a074b0-1da0-4deb-b704-78bad332ace2";
        ...
        tls = {
          ...
          reality = {
            enabled = true;
            public_key = "ByRc_nkaEJnhlArydxeMZ8y5M1aRrh2XlgJ19AC5Phs";
            short_id = "68337fa671b0b5fb";
          };
          utls = {
            enabled = true;
            fingerprint = "chrome";
    ...
    route = {
      ...
      rules = [
        ...
        {
          process_path = [
            "~/.nix-profile/bin/mullvad-browser"
          ];
          outbound = "proxy";
        }
        {
